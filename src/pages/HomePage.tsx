      ...
      <div className="hero">
        <TiltWrapper>
          <article className="card" style={{ position: 'relative', overflow: 'hidden' }}>
            {/* Cinematic Glow overlay inside card */}
            <div style={{
        ...
        <aside className="status-card">
          <div className="status-card__label" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <span style={{
              ...
              background: 'var(--brand-accent)', boxShadow: '0 0 10px var(--brand-accent)',
              display: 'inline-block', animation: 'pulse-neon 2s infinite'
            }}></span>
            Platform Status
          </div>
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', background: 'rgba(0,0,0,0.3)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}>
            <div style={{ fontSize: '0.8rem', color: 'var(--brand-primary)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.5rem', fontWeight: 700 }}>Next Battle</div>
